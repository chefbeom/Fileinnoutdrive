...
class TestRunner {
    protected static String baseUrl = System.getProperty('baseUrl', 'http://192.100.220.17:8080/user')
    ...
    @Test
    void test() {
        def response = postJson('/user/signup', [
                email   : prop('signupEmail', 'ngrinder.' + System.currentTimeMillis() + '@example.com'),
                name    : prop('signupName', 'ngrinder-user'),
                password: prop('signupPassword', 'P@ssw0rd!')
        ])
