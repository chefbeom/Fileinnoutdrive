package ngrinder.user.verifyEmail
...
class TestRunner {
    ...
    @Test
    void test() {
        def response = get('/user/verify', [token: prop('verificationToken', 'REPLACE_WITH_VERIFICATION_TOKEN')])
