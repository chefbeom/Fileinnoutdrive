package ngrinder.file.manage.renameFolder
...
class TestRunner {
    ...
    static void beforeProcess() {
        initProcess("file-manage-rename-folder")
    }
    ...
    @Test
    void test() {
        def response = patchJson('/file/' + propLong('fileIdx', 1L) + '/rename', [
                fileName: prop('fileName', 'ngrinder-renamed')
        ])
