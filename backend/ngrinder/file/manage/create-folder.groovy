package ngrinder.file.manage.createFolder
...
class TestRunner {
    ...
    static void beforeProcess() {
        initProcess("file-manage-create-folder")
    }
    ...
    @Test
    void test() {
        def response = postJson('/file/folder', [
                folderName: prop('folderName', 'ngrinder-folder'),
