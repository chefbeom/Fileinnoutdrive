package ngrinder.file.manage.moveFilesToFolder
...
class TestRunner {
    ...
    static void beforeProcess() {
        initProcess("file-manage-move-files-to-folder")
    }
    ...
    @Test
    void test() {
        def response = patchJson('/file/move', [
                fileIdxList   : [propLong('fileIdx1', 1L), propLong('fileIdx2', 2L)],
                targetParentId: propLong('targetParentId', 0L)
        ])
