package ngrinder.file.share.cancelShare
...
class TestRunner {
    ...
    static void beforeProcess() {
        initProcess("file-share-cancel-share")
    }
    ...
    @Test
    void test() {
        def response = postJson('/file/share/cancel', [
                fileIdxList    : [propLong('fileIdx1', 1L), propLong('fileIdx2', 2L)],
                recipientEmail : prop('recipientEmail', 'recipient@example.com')
        ])
