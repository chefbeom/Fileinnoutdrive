package ngrinder.file.share.sharedTextPreview
...
class TestRunner {
    ...
    static void beforeProcess() {
        initProcess("file-share-shared-text-preview")
    }
    ...
    @Test
    void test() {
        def response = get('/file/share/shared/' + propLong('fileIdx', 1L) + '/text-preview')
