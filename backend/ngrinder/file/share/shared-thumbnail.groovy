package ngrinder.file.share.sharedThumbnail
...
class TestRunner {
    ...
    static void beforeProcess() {
        initProcess("file-share-shared-thumbnail")
    }
    ...
    @Test
    void test() {
        def response = get('/file/share/shared/' + propLong('fileIdx', 1L) + '/thumbnail')
        assertStatus(response, [200, 204, 304])
    }
}
