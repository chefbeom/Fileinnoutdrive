package ngrinder.file.share.downloadSharedFile
...
class TestRunner {
    ...
    static void beforeProcess() {
        initProcess("file-share-download-shared-file")
    }
    ...
    @Test
    void test() {
        def response = get('/file/share/shared/' + propLong('fileIdx', 1L) + '/download')
