package ngrinder.file.share.saveSharedFileToDrive
...
class TestRunner {
    ...
    static void beforeProcess() {
        initProcess("file-share-save-shared-file-to-drive")
    }
    ...
    @Test
    void test() {
        def response = postJson('/file/share/shared/' + propLong('fileIdx', 1L) + '/save', [
