package ngrinder.feater.updateSettings
...
class TestRunner {
    ...
    static void beforeProcess() {
        initProcess("feater-update-settings")
    }
    ...
    @Test
    void test() {
        def response = putJson('/feater/settings/me', [
                displayName        : prop('displayName', 'ngrinder-user'),
                localeCode         : prop('localeCode', 'ko-KR'),
                regionCode         : prop('regionCode', 'KR'),
                marketingOptIn     : true,
                privateProfile     : false,
                emailNotification  : true,
                securityNotification: true,
                profileImageUrl    : prop('profileImageUrl', '')
        ])
