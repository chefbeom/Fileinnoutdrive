package ngrinder.administrator.storageAnalytics
...
class TestRunner {
    ...
    static void beforeProcess() {
        initProcess("administrator-storage-analytics")
    }
    ...
    @Test
    void test() {
        def response = get('/administrator/storage-analytics', [range: prop('range', '24H')])
