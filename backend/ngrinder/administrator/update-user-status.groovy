package ngrinder.administrator.updateUserStatus
...
class TestRunner {
    ...
    static void beforeProcess() {
        initProcess("administrator-update-user-status")
    }
    ...
    @Test
    void test() {
        def response = patchJson('/administrator/users/' + propLong('targetUserIdx', 1L) + '/status', [
                accountStatus: prop('accountStatus', 'SUSPENDED')
        ])
