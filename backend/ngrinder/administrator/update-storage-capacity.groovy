package ngrinder.administrator.updateStorageCapacity
...
class TestRunner {
    protected static String baseUrl = System.getProperty('baseUrl', 'http://192.100.220.17:8080/administrator')
    ...
    static void beforeProcess() {
        initProcess("administrator-update-storage-capacity")
    }
    ...
    @Test
    void test() {
        def response = patchJson('/administrator/storage-capacity', [
                providerCapacityBytes: propLong('providerCapacityBytes', 1099511627776L)
        ])
