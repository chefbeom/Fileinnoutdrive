...
class TestRunner {
    protected static String baseUrl = System.getProperty('baseUrl', 'http://192.100.220.17:8080/auth')
    ...
    @Test
    void test() {
        def response = postEmpty('/auth/reissue', refreshHeaders())
