package ngrinder.chat.sendMessageWs
...
/*
 * WebSocket/STOMP placeholder for an authenticated SockJS probe.
 * This keeps ATOKEN in use until a real WebSocket harness is added.
 */

@RunWith(GrinderRunner)
class TestRunner {
    protected static String baseUrl = System.getProperty('baseUrl', 'http://192.100.220.17:8080/ws-stomp')
    ...
    @Test
    void test() {
        def response = get('/ws-stomp/info', [t: System.currentTimeMillis()])
