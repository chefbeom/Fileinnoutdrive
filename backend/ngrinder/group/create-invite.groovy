package ngrinder.group.createInvite
...
class TestRunner {
    ...
    static void beforeProcess() {
        initProcess("group-create-invite")
    }
    ...
    @Test
    void test() {
        def response = postJson('/group/invites', [
                toUserId: propLong('toUserId', 2L),
                email   : prop('inviteEmail', 'invitee@example.com'),
                type    : prop('inviteType', 'FRIEND')
        ])
