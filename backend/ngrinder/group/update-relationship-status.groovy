package ngrinder.group.updateRelationshipStatus
...
class TestRunner {
    ...
    static void beforeProcess() {
        initProcess("group-update-relationship-status")
    }
    ...
    @Test
    void test() {
        def response = patchJson('/group/relationships/' + propLong('relationshipId', 1L) + '/status', [
                status: prop('relationshipStatus', 'BLOCKED')
        ])
