package ngrinder.group.replaceRelationshipGroups
...
class TestRunner {
    ...
    static void beforeProcess() {
        initProcess("group-replace-relationship-groups")
    }
    ...
    @Test
    void test() {
        def response = putJson('/group/relationships/' + propLong('relationshipId', 1L) + '/groups', [
                groupIds: [propLong('groupId1', 1L), propLong('groupId2', 2L)]
        ])
