package ngrinder.group.share.shareFiles
...
class TestRunner {
    ...
    @Test
    void test() {
        def response = postJson('/group/share/files', [
                fileIds : [propLong('fileId1', 1L), propLong('fileId2', 2L)],
