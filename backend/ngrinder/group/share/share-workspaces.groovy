package ngrinder.group.share.shareWorkspaces
...
class TestRunner {
    protected static String baseUrl = System.getProperty('baseUrl', 'http://192.100.220.17:8080/group')
    ...
    static void beforeProcess() {
        initProcess("group-share-workspaces")
    }
    ...
    @Test
    void test() {
        def response = postJson('/group/share/workspaces', [
                workspaceId: propLong('workspaceId', 1L),
                userIds    : [propLong('targetUserId1', 2L)],
                groupIds   : [propLong('groupId1', 3L)],
                emails     : [prop('recipientEmail', 'recipient@example.com')]
        ])
