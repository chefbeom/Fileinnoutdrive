package ngrinder.group.addRelationshipToGroup
...
class TestRunner {
    ...
    static void beforeProcess() {
        initProcess("group-add-relationship-to-group")
    }
    ...
    @Test
    void test() {
        def response = postJson('/group/relationships/' + propLong('relationshipId', 1L) + '/groups', [
                groupId: propLong('groupId', 1L)
        ])
