package ngrinder.group.renameGroup
...
class TestRunner {
    ...
    static void beforeProcess() {
        initProcess("group-rename-group")
    }
    ...
    @Test
    void test() {
        def response = patchJson('/group/groups/' + propLong('groupId', 1L), [
                name: prop('groupName', 'ngrinder-group-renamed')
        ])
