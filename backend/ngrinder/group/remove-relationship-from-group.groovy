package ngrinder.group.removeRelationshipFromGroup
...
class TestRunner {
    ...
    static void beforeProcess() {
        initProcess("group-remove-relationship-from-group")
    }
    ...
    @Test
    void test() {
        def response = deleteReq('/group/relationships/' + propLong('relationshipId', 1L) + '/groups/' + propLong('groupId', 1L))
