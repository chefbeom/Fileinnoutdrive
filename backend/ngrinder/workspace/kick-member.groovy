package ngrinder.workspace.kickMember
...
class TestRunner {
    ...
    static void beforeProcess() {
        initProcess("workspace-kick-member")
    }
    ...
    @Test
    void test() {
        def response = deleteReq('/workspace/' + propLong('workspaceIdx', 1L) + '/member/' + propLong('targetUserIdx', 2L))
