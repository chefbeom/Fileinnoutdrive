package ngrinder.workspace.save
...
class TestRunner {
    ...
    @Test
    void test() {
        def response = postJson('/workspace/save', [
                idx     : null,
                title   : prop('workspaceTitle', 'ngrinder-workspace'),
                contents: prop('workspaceContents', 'test contents')
        ])
