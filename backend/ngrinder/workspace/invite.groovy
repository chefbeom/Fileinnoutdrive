package ngrinder.workspace.invite
...
class TestRunner {
    ...
    @Test
    void test() {
        def response = postEmpty('/workspace/invite?uuid=' + prop('workspaceUuid', 'REPLACE_WITH_WORKSPACE_UUID') + '&email=' + prop('inviteEmail', 'invitee@example.com'))
