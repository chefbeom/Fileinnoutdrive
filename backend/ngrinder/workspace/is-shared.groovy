package ngrinder.workspace.isShared
...
class TestRunner {
    ...
    static void beforeProcess() {
        initProcess("workspace-is-shared")
    }
    ...
    @Test
    void test() {
        def response = postJson('/workspace/isShared/' + propLong('workspaceIdx', 1L), [
                type  : true,
                status: prop('shareStatus', 'Shared')
        ])
