package ngrinder.workspace.readByUuid
...
class TestRunner {
    ...
    static void beforeProcess() {
        initProcess("workspace-read-by-uuid")
    }
    ...
    @Test
    void test() {
        def response = get('/workspace/by-uuid/' + prop('workspaceUuid', 'REPLACE_WITH_WORKSPACE_UUID'))
