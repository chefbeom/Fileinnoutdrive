package ngrinder.workspace.verifyEmail
...
class TestRunner {
    ...
    static void beforeProcess() {
        initProcess("workspace-verify-email")
    }
    ...
    @Test
    void test() {
        def response = get('/workspace/verify', [
                uuid: prop('workspaceUuid', 'REPLACE_WITH_WORKSPACE_UUID'),
                type: prop('inviteDecision', 'accept')
        ])
