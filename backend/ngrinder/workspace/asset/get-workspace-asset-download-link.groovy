package ngrinder.workspace.asset.getWorkspaceAssetDownloadLink
...
class TestRunner {
    ...
    static void beforeProcess() {
        initProcess("workspace-asset-get-download-link")
    }
    ...
    @Test
    void test() {
        def response = get('/workspace/' + propLong('workspaceId', 1L) + '/assets/' + propLong('assetId', 1L) + '/download-link')
