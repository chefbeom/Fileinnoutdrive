package ngrinder.workspace.asset.saveAssetToDrive
...
class TestRunner {
    ...
    static void beforeProcess() {
        initProcess("workspace-asset-save-asset-to-drive")
    }
    ...
    @Test
    void test() {
        def response = postEmpty('/workspace/' + propLong('workspaceId', 1L) + '/assets/' + propLong('assetId', 1L) + '/save-to-drive?parentId=' + propLong('parentId', 0L))
