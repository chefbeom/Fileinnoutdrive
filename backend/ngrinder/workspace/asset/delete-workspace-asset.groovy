package ngrinder.workspace.asset.deleteWorkspaceAsset
...
class TestRunner {
    ...
    static void beforeProcess() {
        initProcess("workspace-asset-delete-workspace-asset")
    }
    ...
    @Test
    void test() {
        def response = deleteReq('/workspace/' + propLong('workspaceId', 1L) + '/assets/' + propLong('assetId', 1L))
