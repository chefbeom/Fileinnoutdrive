package ngrinder.workspace.asset.downloadWorkspaceAsset
...
class TestRunner {
    ...
    static void beforeProcess() {
        initProcess("workspace-asset-download-workspace-asset")
    }
    ...
    @Test
    void test() {
        def response = get('/workspace/' + propLong('workspaceId', 1L) + '/assets/' + propLong('assetId', 1L) + '/download')
