package ngrinder.workspace.asset.deleteEditorJsImage
...
class TestRunner {
    ...
    static void beforeProcess() {
        initProcess("workspace-asset-delete-editorjs-image")
    }
    ...
    @Test
    void test() {
        def response = deleteReq('/workspace/' + propLong('workspaceId', 1L) + '/assets/' + propLong('assetIdx', 1L) + '/editorjs')
