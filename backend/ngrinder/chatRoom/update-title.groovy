package ngrinder.chatRoom.updateTitle
...
class TestRunner {
    ...
    static void beforeProcess() {
        initProcess("chat-room-update-title")
    }
    ...
    @Test
    void test() {
        def response = patchJson('/chatRoom/' + propLong('roomId', 1L) + '/title', [
                title: prop('roomTitle', 'ngrinder-room-renamed')
        ])
