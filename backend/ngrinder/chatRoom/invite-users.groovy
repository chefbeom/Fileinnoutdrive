package ngrinder.chatRoom.inviteUsers
...
class TestRunner {
    ...
    static void beforeProcess() {
        initProcess("chat-room-invite-users")
    }
    ...
    @Test
    void test() {
        def response = postJson('/chatRoom/' + propLong('roomId', 1L) + '/invite', [
                prop('inviteEmail1', 'user1@example.com'),
                prop('inviteEmail2', 'user2@example.com')
        ])
