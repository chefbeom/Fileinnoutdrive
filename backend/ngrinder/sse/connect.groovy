...
class TestRunner {
    ...
    void beforeThread() {
        ...
        login()
        request.setReadBytes(256)
        request.setVersionPolicy(org.apache.hc.core5.http2.HttpVersionPolicy.FORCE_HTTP_1)
    }

    @Test
    void test() {
        def response = get('/sse/connect')
